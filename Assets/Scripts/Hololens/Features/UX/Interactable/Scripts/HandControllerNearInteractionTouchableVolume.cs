...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class HandControllerNearInteractionTouchableVolume : BaseNearInteractionTouchable
    {
        /// <summary>
        ...
        private void Start()
        {
            var pointerHandler = GetComponent<PointerHandler>();  //gameObject.AddComponent<PointerHandler>();
        ...
        void Update()
        {
            touchableCollider = GetComponent<MeshCollider>();
